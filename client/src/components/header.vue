<template>
  <div class="header">
    <a class="neko" @click="back">
      <img src="@/assets/images/logo.svg" alt="ee.st" />
      <span><b>EE</b>.ST</span>
    </a>
    <ul class="menu">
      <li>
        <i :class="[{ disabled: !admin }, { locked: isLocked('control') }, 'fas', 'fa-mouse']"
          @click="toggleLock('control')" v-tooltip="{
      ...
      <li>
        <i :class="[{ disabled: !admin }, { locked: isLocked('login') }, locked ? 'fa-lock' : 'fa-lock-open', 'fas']"
          @click="toggleLock('login')" v-tooltip="{
      ...
      <li v-if="fileTransfer">
        <i :class="[{ disabled: !admin }, { locked: isLocked('file_transfer') }, 'fas', 'fa-file']"
          @click="toggleLock('file_transfer')" v-tooltip="{
